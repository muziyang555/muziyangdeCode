...
tr:nth-of-type(even){ background:#eae3be} /* odd 标识奇数行，even标识偶数行 */
...
<body>
					...
					<nav class="navbar navbar-default" role="navigation">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								<li><a href="index.action?user.UserName=<s:property value="user.UserName"/>">主页</a></li>
	...
	<div align="center" style="padding: 10px;">
        <form action="Money_out_Add" method="post">
		            分类：<select name="mo.type" id="type" style="background: #fff;">
		            ...
		            账户：<select name="mo.accounttype" style="background: #fff;">
		            <option value="">请选择</option>
		            <option value="现金">现金</option>
		            <option value="银行卡">银行卡</option>
		        </select>
		        <br/>
		            时间：<input type="date" name="mo.time" style="width:250px;">		
		            商家：<input type="text" id="name" name="mo.shop" style="width:250px;">		
		         <br/>		            
		            备注：<input type="text" id="name" name="mo.note" id="note" style="width:250px;">		
		            金额：<input type="text" id="name" name="mo.money" style="width:250px;">
				 <br/>
				 
		<input class="button" type="submit" value="记一笔" style="mmargin-left: 900px;padding-left: 6px;margin-left: 450px;"/>				
        </form>
    </div>
...
<table >
    	...
    	<td>支出类型:<s:select list="{'','食品','衣服','交通','医疗'}" name="moq.type" style="background: #fff;width: 160px;"/></td>
    	<td>账户类型:<s:select list="{'','现金','银行卡'}" name="moq.accounttype" style="background: #fff;width: 160px;"/></td> 
    	<td>时间:<input type="date" name="moq.time" style="width: 130px;"></td>
<!--     	<td>范围时间:<input type="date" name="moq.time2"></td> -->
    	<td>商家:<s:textfield name="moq.shop" style="width: 130px;"/></td>
 		<td>备注:<s:textfield name="moq.note" style="width: 130px;"/></td>
    	<td>金额:<s:textfield name="moq.money" style="width: 130px;"/></td>
    	<td><input class="button" type="submit" value="查询"/></td></tr>
</table>	
...
<s:iterator value="moList">
            <tr>
                ...
                <input type="button" value="删除" class="sgBtn" id="btn7"             
               	onclick= "javascript:if(confirm('你确定要删除吗？')) window.location.href='Money_out_Delete.action?mo.moneyoutid=<s:property value='moneyoutid'/>'"></td>
	            </tr>
		          </s:iterator> 
           </tbody> 
	</table>
